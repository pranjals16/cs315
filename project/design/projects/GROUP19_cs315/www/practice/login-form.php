...
<p>&nbsp;</p>
<form id="loginForm" name="loginForm" method="post" action="login-exec.php" target="content" class="style1" >
...
<form id="loginForm" name="loginForm" method="post" action="temporary.php"  onsubmit="return validateForm10(this) ;">
  <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td width="112"><b>Login</b></td>
      <td width="188"><input name="login" type="text" class="textfield" id="login" /></td>
